...
func (e DebtEdges) InvoiceOrErr() (*Invoice, error) {
	if e.Invoice != nil {
...
// was not loaded in eager-loading, or loaded but was not found.
func (e DebtEdges) StatusOrErr() (*PaymentStatus, error) {
	if e.Status != nil {
		return e.Status, nil
...
// QueryInvoice queries the "invoice" edge of the Debt entity.
func (d *Debt) QueryInvoice() *InvoiceQuery {
	return NewDebtClient(d.config).QueryInvoice(d)
}
...
// QueryStatus queries the "status" edge of the Debt entity.
func (d *Debt) QueryStatus() *PaymentStatusQuery {
	return NewDebtClient(d.config).QueryStatus(d)
}
