...
func (du *DebtUpdate) SetInvoice(i *Invoice) *DebtUpdate {
...
func (du *DebtUpdate) SetStatus(p *PaymentStatus) *DebtUpdate {
	return du.SetStatusID(p.ID)
}
...
func (du *DebtUpdate) ClearInvoice() *DebtUpdate {
	du.mutation.ClearInvoice()
	return du
}
...
func (du *DebtUpdate) ClearStatus() *DebtUpdate {
...
func (du *DebtUpdate) sqlSave(ctx context.Context) (n int, err error) {
	...
	if du.mutation.InvoiceCleared() {
		edge := &sqlgraph.EdgeSpec{
			Rel:     sqlgraph.M2O,
			Inverse: false,
			Table:   debt.InvoiceTable,
			Columns: []string{debt.InvoiceColumn},
			Bidi:    false,
	...
	if nodes := du.mutation.InvoiceIDs(); len(nodes) > 0 {
		edge := &sqlgraph.EdgeSpec{
			Rel:     sqlgraph.M2O,
			Inverse: false,
			Table:   debt.InvoiceTable,
	...
	if du.mutation.StatusCleared() {
		edge := &sqlgraph.EdgeSpec{
			Rel:     sqlgraph.M2O,
			Inverse: false,
			Table:   debt.StatusTable,
			Columns: []string{debt.StatusColumn},
			Bidi:    false,
			Target: &sqlgraph.EdgeTarget{
...
// SetInvoice sets the "invoice" edge to the Invoice entity.
func (duo *DebtUpdateOne) SetInvoice(i *Invoice) *DebtUpdateOne {
...
// SetStatus sets the "status" edge to the PaymentStatus entity.
func (duo *DebtUpdateOne) SetStatus(p *PaymentStatus) *DebtUpdateOne {
	return duo.SetStatusID(p.ID)
}
...
// ClearInvoice clears the "invoice" edge to the Invoice entity.
func (duo *DebtUpdateOne) ClearInvoice() *DebtUpdateOne {
	duo.mutation.ClearInvoice()
	return duo
}
...
// ClearStatus clears the "status" edge to the PaymentStatus entity.
func (duo *DebtUpdateOne) ClearStatus() *DebtUpdateOne {
...
func (duo *DebtUpdateOne) sqlSave(ctx context.Context) (_node *Debt, err error) {
	...
	if nodes := duo.mutation.InvoiceIDs(); len(nodes) > 0 {
		edge := &sqlgraph.EdgeSpec{
			Rel:     sqlgraph.M2O,
			Inverse: false,
			Table:   debt.InvoiceTable,
